...
// Add layer groups to the overlays object.
let overlays = {
...
d3.json('https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson').then(function(data) {
  // set the style for Major Earthquake layer
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
  ...
  // Set the marker color based on the magnitude of the earthquake.
  function getColor(magnitude) {
    if (magnitude > 6) {
      return "#602320";
    }
  ...
  // Set marker size based on the magnitude.
  function getRadius(magnitude) {
    if (magnitude === 0) {
      return 1;
    }
